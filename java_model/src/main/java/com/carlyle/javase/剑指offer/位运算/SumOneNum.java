package com.carlyle.javase.剑指offer.位运算;
 ...
 * 一个1那一位开始所有位都会变成0。如1100&1011=1000.也就是说，把一个
 * 整数减去1，再和原整数做与运算，会把该整数最右边一个1变成0.那么一个整数的 二进制有多少个1，就可以进行多少次这样的操作。
 * */
public class SumOneNum {
	...
	public static void main(String[] args) {
		...
		System.out.println("总数：" + NumberOf1(3));
		System.out.println("总数===：" + NumberOf12(3));
	}
}
